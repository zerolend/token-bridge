...
describe('ZeroOFT Test', function () {
    ...
    before(async function () {
        ...
        ZeroOFTzkSync = await ethers.getContractAt('ZeroOFT', "0x7a77B4003DC499c82D4A7A7e8fF340cA8308f9eb")
    ...
    it('should send a token from A address to B address via each OFT', async function () {
        ...
        const messageLibAddresses = ['0xc1b621b18187f74c8f6d52a6f709dd2780c09821', '0x377530cda84dfb2673bf4d145dcf0c4d7fdcb5b6']; //Blast
        ...
        let endpointContract:any = await ethers.getContractAtFromArtifact(EndpointV2MockArtifact, '0x1a44076050125825900e736c501f859c50fE728c')
